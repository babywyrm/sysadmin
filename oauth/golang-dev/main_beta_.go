...
const (
    codeExpiry   = 90 * time.Second  // Set authorization code expiry to 90 seconds
    tokenExpiry  = 5 * time.Minute   // Set token expiry to 5 minutes
)
...
func authHandler(w http.ResponseWriter, r *http.Request) {
    ...
    if clientID != "your-client-id" || redirectURI != "http://localhost:8080/callback" || responseType != "code" {
