...
##
#
https://gist.github.com/jakewarren/136707093f3cfdedb6fabfaddd513072
#
...
This auditd ruleset is a fork of Neo23x0/auditd, and includes some rules from bfuzzy/auditd-attack

# edit the rules 
sudo vim /etc/audit/rules.d/audit.rules

# read in the rules, look for any error messages
sudo auditctl -R /etc/audit/rules.d/audit.rules

# list the rules loaded into auditd as a final check 
sudo auditctl -l
```
#      ___             ___ __      __
#     /   | __  ______/ (_) /_____/ /
...
-w /usr/sbin/stunnel -p x -k sbin_susp
...
### https://elastic.github.io/security-research/intelligence/2022/03/03.dirty-pipe/article/
