...
helm install cilium cilium/cilium --version 1.9.5 \
  ...
  --set k8sServiceHost=<REDACTED_CLUSTER_HOST> \
...
data:
  k8s-shared-cluster: <REDACTED_CLUSTER_SECRET>
  k8s-shared-cluster.etcd-client-ca.crt: <REDACTED_CLUSTER_SECRET>
  k8s-shared-cluster.etcd-client.crt: <REDACTED_CLUSTER_SECRET>
  k8s-shared-cluster.etcd-client.key: <REDACTED_CLUSTER_SECRET>
  k8s-test-cluster: <REDACTED_CLUSTER_SECRET>
  k8s-test-cluster.etcd-client-ca.crt: <REDACTED_CLUSTER_SECRET>
  k8s-test-cluster.etcd-client.crt: <REDACTED_CLUSTER_SECRET>
  k8s-test-cluster.etcd-client.key: <REDACTED_CLUSTER_SECRET>
