...
def run(image, clear_cache, severity, vuln_type, ignore_unfixed, refresh_db, output_markdown):
    """
    ...
    Args:
        ...
        output_markdown (bool): If True, save output as Markdown; otherwise print plain text.
    """
...
if __name__ == "__main__":
    ...
    parser.add_argument("--markdown", action="store_true", help="Output results as a Markdown file (default is plain text)")
    args = parser.parse_args()

    run(args.image, args.clear_cache, args.severity, args.vuln_type, args.ignore_unfixed, args.refresh_db, args.markdown)
