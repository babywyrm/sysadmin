...
| CVE-2024-2236 | {'redhat': {'V3Vector': 'CVSS:3.1/AV:N/AC:H/PR:N/UI:N/S:U/C:H/I:N/A:N', 'V3Score': 5.9}} |  | 1.9.4-3ubuntu3 | libgcrypt20 | libgcrypt: vulnerable to Marvin Attack |

| CVE-2024-26462 | {'redhat': {'V3Vector': 'CVSS:3.1/AV:N/AC:L/PR:N/UI:N/S:U/C:N/I:N/A:H', 'V3Score': 7.5}} |  | 1.19.2-2ubuntu0.3 | libgssapi-krb5-2 | krb5: Memory leak at /krb5/src/kdc/ndr.c |

| CVE-2024-26462 | {'redhat': {'V3Vector': 'CVSS:3.1/AV:N/AC:L/PR:N/UI:N/S:U/C:N/I:N/A:H', 'V3Score': 7.5}} |  | 1.19.2-2ubuntu0.3 | libk5crypto3 | krb5: Memory leak at /krb5/src/kdc/ndr.c |

| CVE-2024-26462 | {'redhat': {'V3Vector': 'CVSS:3.1/AV:N/AC:L/PR:N/UI:N/S:U/C:N/I:N/A:H', 'V3Score': 7.5}} |  | 1.19.2-2ubuntu0.3 | libkrb5-3 | krb5: Memory leak at /krb5/src/kdc/ndr.c |

| CVE-2024-26462 | {'redhat': {'V3Vector': 'CVSS:3.1/AV:N/AC:L/PR:N/UI:N/S:U/C:N/I:N/A:H', 'V3Score': 7.5}} |  | 1.19.2-2ubuntu0.3 | libkrb5support0 | krb5: Memory leak at /krb5/src/kdc/ndr.c |

| CVE-2020-22916 | {'nvd': {'V3Vector': 'CVSS:3.1/AV:L/AC:L/PR:N/UI:R/S:U/C:N/I:N/A:H', 'V3Score': 5.5}, 'redhat': {'V3Vector': 'CVSS:3.1/AV:L/AC:L/PR:N/UI:R/S:U/C:N/I:N/A:H', 'V3Score': 5.5}} |  | 5.2.5-2ubuntu1 | liblzma5 | Denial of service via decompression of crafted file |

| CVE-2023-24538 | {'bitnami': {'V3Vector': 'CVSS:3.1/AV:N/AC:L/PR:N/UI:N/S:U/C:H/I:H/A:H', 'V3Score': 9.8}, 'nvd': {'V3Vector': 'CVSS:3.1/AV:N/AC:L/PR:N/UI:N/S:U/C:H/I:H/A:H', 'V3Score': 9.8}, 'redhat': {'V3Vector': 'CVSS:3.1/AV:N/AC:L/PR:N/UI:N/S:U/C:H/I:H/A:H', 'V3Score': 9.8}} | 1.19.8, 1.20.3 | 1.18.2 | stdlib | golang: html/template: backticks not treated as string delimiters |

| CVE-2023-24540 | {'bitnami': {'V3Vector': 'CVSS:3.1/AV:N/AC:L/PR:N/UI:N/S:U/C:H/I:H/A:H', 'V3Score': 9.8}, 'nvd': {'V3Vector': 'CVSS:3.1/AV:N/AC:L/PR:N/UI:N/S:U/C:H/I:H/A:H', 'V3Score': 9.8}, 'redhat': {'V3Vector': 'CVSS:3.1/AV:N/AC:H/PR:N/UI:N/S:U/C:H/I:H/A:H', 'V3Score': 8.1}} | 1.19.9, 1.20.4 | 1.18.2 | stdlib | golang: html/template: improper handling of JavaScript whitespace |

| CVE-2024-24790 | {'bitnami': {'V3Vector': 'CVSS:3.1/AV:N/AC:L/PR:N/UI:N/S:U/C:H/I:H/A:H', 'V3Score': 9.8}, 'nvd': {'V3Vector': 'CVSS:3.1/AV:N/AC:L/PR:N/UI:N/S:U/C:H/I:H/A:H', 'V3Score': 9.8}, 'redhat': {'V3Vector': 'CVSS:3.1/AV:L/AC:H/PR:N/UI:N/S:U/C:H/I:H/A:N', 'V3Score': 6.7}} | 1.21.11, 1.22.4 | 1.18.2 | stdlib | golang: net/netip: Unexpected behavior from Is methods for IPv4-mapped IPv6 addresses |

| CVE-2022-27664 | {'bitnami': {'V3Vector': 'CVSS:3.1/AV:N/AC:L/PR:N/UI:N/S:U/C:N/I:N/A:H', 'V3Score': 7.5}, 'ghsa': {'V3Vector': 'CVSS:3.1/AV:N/AC:L/PR:N/UI:N/S:U/C:N/I:N/A:H', 'V3Score': 7.5}, 'nvd': {'V3Vector': 'CVSS:3.1/AV:N/AC:L/PR:N/UI:N/S:U/C:N/I:N/A:H', 'V3Score': 7.5}, 'redhat': {'V3Vector': 'CVSS:3.1/AV:N/AC:L/PR:L/UI:N/S:U/C:N/I:N/A:H', 'V3Score': 6.5}} | 1.18.6, 1.19.1 | 1.18.2 | stdlib | golang: net/http: handle server errors after sending GOAWAY |

| CVE-2022-28131 | {'bitnami': {'V3Vector': 'CVSS:3.1/AV:N/AC:L/PR:N/UI:N/S:U/C:N/I:N/A:H', 'V3Score': 7.5}, 'nvd': {'V3Vector': 'CVSS:3.1/AV:N/AC:L/PR:N/UI:N/S:U/C:N/I:N/A:H', 'V3Score': 7.5}, 'redhat': {'V3Vector': 'CVSS:3.1/AV:L/AC:L/PR:N/UI:N/S:U/C:L/I:L/A:H', 'V3Score': 7.3}} | 1.17.12, 1.18.4 | 1.18.2 | stdlib | golang: encoding/xml: stack exhaustion in Decoder.Skip |

| CVE-2022-2879 | {'bitnami': {'V3Vector': 'CVSS:3.1/AV:N/AC:L/PR:N/UI:N/S:U/C:N/I:N/A:H', 'V3Score': 7.5}, 'nvd': {'V3Vector': 'CVSS:3.1/AV:N/AC:L/PR:N/UI:N/S:U/C:N/I:N/A:H', 'V3Score': 7.5}, 'redhat': {'V3Vector': 'CVSS:3.1/AV:N/AC:L/PR:L/UI:N/S:U/C:N/I:N/A:H', 'V3Score': 6.5}} | 1.18.7, 1.19.2 | 1.18.2 | stdlib | golang: archive/tar: unbounded memory consumption when reading headers |

| CVE-2022-2880 | {'bitnami': {'V3Vector': 'CVSS:3.1/AV:N/AC:L/PR:N/UI:N/S:U/C:N/I:H/A:N', 'V3Score': 7.5}, 'nvd': {'V3Vector': 'CVSS:3.1/AV:N/AC:L/PR:N/UI:N/S:U/C:N/I:H/A:N', 'V3Score': 7.5}, 'redhat': {'V3Vector': 'CVSS:3.1/AV:N/AC:L/PR:N/UI:N/S:U/C:N/I:H/A:N', 'V3Score': 7.5}} | 1.18.7, 1.19.2 | 1.18.2 | stdlib | golang: net/http/httputil: ReverseProxy should not forward unparseable query parameters |

| CVE-2022-29804 | {'bitnami': {'V3Vector': 'CVSS:3.1/AV:N/AC:L/PR:N/UI:N/S:U/C:H/I:N/A:N', 'V3Score': 7.5}, 'nvd': {'V3Vector': 'CVSS:3.1/AV:N/AC:L/PR:N/UI:N/S:U/C:H/I:N/A:N', 'V3Score': 7.5}} | 1.17.11, 1.18.3 | 1.18.2 | stdlib | ELSA-2022-17957: ol8addon security update (IMPORTANT) |

| CVE-2022-30580 | {'bitnami': {'V3Vector': 'CVSS:3.1/AV:L/AC:L/PR:L/UI:N/S:U/C:H/I:H/A:H', 'V3Score': 7.8}, 'nvd': {'V3Vector': 'CVSS:3.1/AV:L/AC:L/PR:L/UI:N/S:U/C:H/I:H/A:H', 'V3Score': 7.8}, 'redhat': {'V3Vector': 'CVSS:3.1/AV:L/AC:L/PR:L/UI:N/S:U/C:H/I:H/A:H', 'V3Score': 7.8}} | 1.17.11, 1.18.3 | 1.18.2 | stdlib | golang: os/exec: Code injection in Cmd.Start |

| CVE-2022-30630 | {'bitnami': {'V3Vector': 'CVSS:3.1/AV:N/AC:L/PR:N/UI:N/S:U/C:N/I:N/A:H', 'V3Score': 7.5}, 'nvd': {'V3Vector': 'CVSS:3.1/AV:N/AC:L/PR:N/UI:N/S:U/C:N/I:N/A:H', 'V3Score': 7.5}, 'redhat': {'V3Vector': 'CVSS:3.1/AV:N/AC:L/PR:N/UI:N/S:U/C:N/I:N/A:H', 'V3Score': 7.5}} | 1.17.12, 1.18.4 | 1.18.2 | stdlib | golang: io/fs: stack exhaustion in Glob |

| CVE-2022-30631 | {'bitnami': {'V3Vector': 'CVSS:3.1/AV:N/AC:L/PR:N/UI:N/S:U/C:N/I:N/A:H', 'V3Score': 7.5}, 'nvd': {'V3Vector': 'CVSS:3.1/AV:N/AC:L/PR:N/UI:N/S:U/C:N/I:N/A:H', 'V3Score': 7.5}, 'redhat': {'V3Vector': 'CVSS:3.1/AV:N/AC:L/PR:N/UI:N/S:U/C:N/I:N/A:H', 'V3Score': 7.5}} | 1.17.12, 1.18.4 | 1.18.2 | stdlib | golang: compress/gzip: stack exhaustion in Reader.Read |

| CVE-2022-30632 | {'bitnami': {'V3Vector': 'CVSS:3.1/AV:N/AC:L/PR:N/UI:N/S:U/C:N/I:N/A:H', 'V3Score': 7.5}, 'nvd': {'V3Vector': 'CVSS:3.1/AV:N/AC:L/PR:N/UI:N/S:U/C:N/I:N/A:H', 'V3Score': 7.5}, 'redhat': {'V3Vector': 'CVSS:3.1/AV:N/AC:L/PR:N/UI:N/S:U/C:N/I:N/A:H', 'V3Score': 7.5}} | 1.17.12, 1.18.4 | 1.18.2 | stdlib | golang: path/filepath: stack exhaustion in Glob |
...
| CVE-2023-24539 | {'bitnami': {'V3Vector': 'CVSS:3.1/AV:N/AC:L/PR:N/UI:N/S:U/C:L/I:L/A:L', 'V3Score': 7.3}, 'nvd': {'V3Vector': 'CVSS:3.1/AV:N/AC:L/PR:N/UI:N/S:U/C:L/I:L/A:L', 'V3Score': 7.3}, 'redhat': {'V3Vector': 'CVSS:3.1/AV:N/AC:L/PR:N/UI:N/S:U/C:L/I:L/A:L', 'V3Score': 7.3}} | 1.19.9, 1.20.4 | 1.18.2 | stdlib | golang: html/template: improper sanitization of CSS values |
...
| CVE-2023-39319 | {'bitnami': {'V3Vector': 'CVSS:3.1/AV:N/AC:L/PR:N/UI:R/S:C/C:L/I:L/A:N', 'V3Score': 6.1}, 'nvd': {'V3Vector': 'CVSS:3.1/AV:N/AC:L/PR:N/UI:R/S:C/C:L/I:L/A:N', 'V3Score': 6.1}, 'redhat': {'V3Vector': 'CVSS:3.1/AV:N/AC:L/PR:N/UI:R/S:C/C:L/I:L/A:N', 'V3Score': 6.1}} | 1.20.8, 1.21.1 | 1.18.2 | stdlib | golang: html/template: improper handling of special tags within script contexts |
